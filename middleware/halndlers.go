...
import (
	...
	"github.com/NamozovAzizbek/go-postgres/models"
...
func createConnection() *sql.DB {
	...
	fmt.Println("Seccesfully connected to postgres!")
...
func UpdateStock(w http.ResponseWriter, r *http.Request) {
	...
	updateRows := updeteStock(int64(id), stock)
...
func updeteStock(id int64, stock models.Stock) int64 {
	db := createConnection()
	defer db.Close()
